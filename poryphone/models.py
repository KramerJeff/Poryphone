...
class SyncPair(models.Model):
  id = models.AutoField(primary_key=True)
  name = models.CharField(max_length=255, null=False, blank=True, unique=True, default='Unown')
  role = models.ForeignKey(Role, on_delete=models.SET_NULL, null=True, blank=True)
  trainer = models.OneToOneField(Trainer, on_delete=models.SET_NULL, related_name='trainer', null=True, blank=True)
...
#A move "belongs" to either a Trainer or a Pokemon - ultimately belonging to a Sync Pair
...
class ItemQuantity(models.Model):
  id = models.AutoField(primary_key=True)
  item = models.ForeignKey(Item, on_delete=models.SET_NULL, related_name='item', null=True, blank=True)
...
class SyncPairMove(models.Model):
  id = models.AutoField(primary_key=True)
  move = models.ForeignKey(Move, on_delete=models.SET_NULL, related_name='move', null=True, blank=True)
  syncpair = models.ForeignKey(SyncPair, on_delete=models.SET_NULL, related_name='syncpair', null=True, blank=True)
  unlock_requirements = models.ManyToManyField(ItemQuantity, related_name='items', blank=True)
